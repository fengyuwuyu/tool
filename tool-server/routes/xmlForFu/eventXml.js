...
exports.create = function(req, res) {
    ...
    var json = {};
    eventXmlModel.create({jsonStr: jsonStr, version: 0, clientVersion: initClientVersion  }, function(err, eventXml) {
        json.result = !!!err;
        json.eventXml = {
            id: eventXml._id,
            jsonStr: jsonStr,
...
exports.checkVersion = function(req, res) {
    ...
    eventXmlModel.find({"_id":ObjectID(id)}, function(err, results) {
        console.log(err);
        if (!results.length) {
            res.send({
                result: false,
...
exports.remove = function(req, res) {
    var id = req.body.id;
    var name = req.body.name;
    eventXmlModel.remove({"_id":ObjectID(id)}, function(err) {
        res.send({
            result: !!!err,
...
exports.list = function(req, res) {
    ...
    eventXmlModel.find({clientVersion : version}, function(err, results) {
        if(err) {
            res.send({
                result: false,
                msg: err
