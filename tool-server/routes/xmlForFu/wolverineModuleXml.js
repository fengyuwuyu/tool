var wolverineModuleXmlModel = require('./../../models/wolverineModuleXml').wolverineModuleXml;
...
exports.create = function(req, res) {
    ...
    var json = {};
    wolverineModuleXmlModel.create({jsonStr: jsonStr, version: 0, clientVersion: initClientVersion }, function(err, moduleXml) {
        json.result = !!!err;
        json.moduleXml = {
            id: moduleXml._id,
            jsonStr: jsonStr
...
exports.checkVersion = function(req, res) {
    ...
    var id = req.body.id;
    wolverineModuleXmlModel.find({"_id":ObjectID(id)}, function(err, results) {
        if (!results.length) {
            res.send({
                result: false,
                msg: "后台已不存在该条数据"
...
exports.update = function(req, res) {
    ...
    wolverineModuleXmlModel.find({"_id":ObjectID(id)}, function(err, results) {
        ...
        var dirOld = "./export/xmlForFu/wolverine/wolverine/rpcXml/";
        var fileOld = dirOld + "/" + nameOld + ".xml";
        checkEmptyDirAndRemove(fileOld, dirOld);

        wolverineModuleXmlModel.update({"_id":ObjectID(id)}, updateJson, {}, function(err) {
            json.result = !!!err;
            json.msg = !err ? "修改成功" : "修改失败，见后台log:"+JSON.stringify(err);
            json.result && (json.version = updateJson.version);
            res.send(json);
            if(json.result) {
                var file = "./export/xmlForFu/wolverine/rpcXml/"+name+".xml";
...
exports.remove = function(req, res) {
    var id = req.body.id;
    var name = req.body.name;
    wolverineModuleXmlModel.remove({"_id":ObjectID(id)}, function(err) {
        res.send({
            result: !!!err,
...
exports.list = function(req, res) {
    ...
    wolverineModuleXmlModel.find({clientVersion : version}, function(err, results) {
        if(err) {
            res.send({
                result: false,
                msg: err
