...
import { ModuleXmlService } from './Service';
...
@Component({
    selector: 'vwvo-xmlMakerForFu-moduleXml',
    templateUrl: './moduleXml.html'
})
export class XmlMakerForFuModuleXmlComponent implements OnInit {

    @Input() active: boolean = false;
    private editting: boolean = false;
    private xmlName: string = "moduleXml";
    ...
    private editor: any;
    private timer: any;
    constructor(private sanitizer: DomSanitizer, private moduleXmlService: ModuleXmlService, private clientComponent: XmlMakerForFuComponent, el: ElementRef, private detectorRef: ChangeDetectorRef, private render: Renderer2) {
    ...
    saveModuleXml() {
        ...
        try {
            ...
            this.moduleXmlService.update({
                ...
                successCallback: (e: any)=> {
                    this.isBusy = false;
                    this.activeModuleXml.downloadUrl = ServerUrl+"xmlForFu/rpcXml/"+name+".xml";
