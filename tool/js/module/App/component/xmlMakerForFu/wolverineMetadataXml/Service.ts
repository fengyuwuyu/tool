...
import {XmlMakerForFuWolverineMetaDataXmlComponent} from "./WolverineMetaDataXml.component";
@Injectable()
export class WolverineMetaDataXmlService {

    private metadataXmlComponent: XmlMakerForFuWolverineMetaDataXmlComponent;
    private _list: any[];
    list(e: any) {
        if(this._list) {
    ...
    getWolverineMetadataXmlComponent() {
        return this.metadataXmlComponent;
    }

    setMetadataXmlComponent(metadataXmlComponent: XmlMakerForFuWolverineMetaDataXmlComponent) {
